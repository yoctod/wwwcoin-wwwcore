...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s wwwcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  wwwcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wwwcoin transaction") + "\n" +
              "  wwwcoin-tx [options] -create [commands]   " + _("Create hex-encoded wwwcoin transaction") + "\n" +
              "\n";
