...
const char * const BITCOIN_CONF_FILENAME = "wwwcoin.conf";
const char * const BITCOIN_PID_FILENAME = "wwwcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Wwwcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Wwwcoin";
#else
    // Unix
    return pathRet / ".wwwcoin";
#endif
#endif
}
