Wwwcoin Core version *0.15.1* is now available from:

  <https://download.wwwcoin.co/wwwcoin-0.15.1/>
...
A number of changes to the way Wwwcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 wwcoins per kB (0.00001 WWW). This is to prepare for dropping the minimum transaction fee to 0.1 wwcoins per kB (0.0001 WWW) in the next release.
